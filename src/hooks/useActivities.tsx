...
import { revalidateAllEvents } from '@/lib/cache/revalidate';
...
export const useActivities = () => {
  ...
  const createActivityMutation = useMutation({
    ...
    onSuccess: async () => {
      ...
      // Revalidate events cache after activity modification (don't throw on failure)
      if (session?.access_token) {
        try {
          await revalidateAllEvents(session.access_token);
