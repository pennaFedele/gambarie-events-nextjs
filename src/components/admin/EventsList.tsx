...
import { revalidateRegularEvents } from '@/lib/cache/revalidate';
...
export const EventsList = () => {
  ...
  const handleDelete = async (eventId: string) => {
    try {
      ...
      // Revalidate events cache after deletion (don't throw on failure)
      if (session?.access_token) {
        try {
          await revalidateRegularEvents(session.access_token);
        ...
        {showCSVImport ? (
          ...
          <EventForm
            ...
            initialData={editingEvent ? {
              ...
              external_link: editingEvent.external_link || undefined,
              image_url: editingEvent.image_url || undefined,
              cancelled: editingEvent.cancelled
            } : undefined}
